...
function ns2cs(label) {
    // hutenosadi
    // 0123456789
    return label.replace(/0/g,"h").replace(/1/g,"u").replace(/2/g,"t").replace(/3/g,"e").replace(/4/g,"n").replace(/5/g,"o").replace(/6/g,"s").replace(/7/g,"a").replace(/8/g,"d").replace(/9/g,"i");
}

function cs2ns(label) {
    // hutenosadi
    // 0123456789
    return label.replace(/h/g,"0").replace(/u/g,"1").replace(/t/g,"2").replace(/e/g,"3").replace(/n/g,"4").replace(/o/g,"5").replace(/s/g,"6").replace(/a/g,"7").replace(/d/g,"8").replace(/i/g,"9");
}
...
function generateHint(el, label) {
    ...
    hint.style.border = '1px solid #4A6600';
    ...
    hint.style.webkitBorderRadius = '2px';
...
function followLinks(follow) {
    var s = follow.split('');
    var linknr = parseInt(cs2ns(follow), 10);
